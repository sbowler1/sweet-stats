...
const event: BotEvent = {
    ...
    execute: async (message: Message) => {
        ...
        let guildPrefsChannel = await prisma.guildPrefs.findFirst({
            where: {
        ...
        if (
            guildPrefsChannel.guildId === message.guild.id &&
            guildPrefsChannel?.channelId === message.channel.id
        ) {
            console.log("Message in leaderboard channel", message);
            message.delete();
            return;
        }
